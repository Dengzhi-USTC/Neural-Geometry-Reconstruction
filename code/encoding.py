...
def get_encoder(encoding, input_dim=3, 
                multires=6, 
                degree=4,
                # num_levels=7, level_dim=4, base_resolution=7, per_level_scale=1.3819, # log2_hashmap_size=15, desired_resolution=128,
                num_levels=16, level_dim=4, base_resolution=16, per_level_scale=1.3819, log2_hashmap_size=19, desired_resolution=2048,
                **kwargs):
    ...
    # Add the dimension of the inputs;
